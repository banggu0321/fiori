		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "전표 생성",
									"targetURL": "#ERzferslipcreate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ERzferslipcreate-display": {
								"semanticObject": "ERzferslipcreate",
								"action": "display",
								"description": "회계 전표 생성",
								"title": "전표 생성",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ER.zferslipcreate",
									"url": sap.ui.require.toUrl("ER/zferslipcreate")
								}
							}
						}
					}

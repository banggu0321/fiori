            ...
            onInit: function () {
                ...
                this.getOwnerComponent().getModel().read("/employeeSet", {
                    success: function(oReturn) {
                        ...
                        this.byId("idLabeluname").setText(`${oReturn.results[0].Branchname} ${oReturn.results[0].Deptname} ${oReturn.results[0].Name} ${oReturn.results[0].Rankname}(${oReturn.results[0].Employeeid})`);
                        if(_rootPath){
                            this.byId("idLoginImage").setSrc(_rootPath+'/image/employee/'+oReturn.results[0].Sapid+'.png');
                        }else{
                            this.byId("idLoginImage").setSrc('/image/employee/'+oReturn.results[0].Sapid+'.png');
                        }
                    }.bind(this)
                });
                this._getdata();
            ...
            _getdata : function(){
                ...
                this.oModel.read(sPath,{ 
                    success:function(oReturn){
                        ...
                        this.oSlipBefore.setProperty("/totalcount",snum);
                        // this.oSlipBefore.setProperty("/wbcount",sliphdatas.length);
                        this._sortStatus();
                    }.bind(this)
                });
                ...
                this.oModel.read(sPath,{
                    success:function(oReturn){
                        ...
                        this.byId("idObjNum").setNumber(snum);
                        this.oSlipBefore.setProperty("/totalcount",snum);
                        // this.oSlipBefore.setProperty("/recount",sliphdatas.length);
                        this._sortStatus();
                    }.bind(this)
                });
                ...
                this.oModel.read(sPath,{
                    success:function(oReturn){
                        ...
                        this.byId("idObjNum").setNumber(snum);
                        this.oSlipBefore.setProperty("/totalcount",snum);
                        // this.oSlipBefore.setProperty("/aucount",sliphdatas.length);
                        this._sortStatus();
                    }.bind(this)
                });
            },

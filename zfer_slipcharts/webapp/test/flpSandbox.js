		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "EReON 회계 실적 차트",
									"targetURL": "#ERzferslipcharts-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ERzferslipcharts-display": {
								"semanticObject": "ERzferslipcharts",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ER.zferslipcharts",
									"url": sap.ui.require.toUrl("ER/zferslipcharts")
								}
							}
						}
					}

		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#exprograme11-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"exprograme11-display": {
								"semanticObject": "exprograme11",
								"action": "display",
								"description": "Exam",
								"title": "App Title",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exprograme11",
									"url": sap.ui.require.toUrl("exprograme11")
								}
							}
						}
					}

		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ERzfersliplp2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ERzfersliplp2-display": {
								"semanticObject": "ERzfersliplp2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ER.zfersliplp2",
									"url": sap.ui.require.toUrl("ER/zfersliplp2")
								}
							}
						}
					}

		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#C05zprojectteste1102-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"C05zprojectteste1102-display": {
								"semanticObject": "C05zprojectteste1102",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=C05.zprojectteste1102",
									"url": sap.ui.require.toUrl("C05/zprojectteste1102")
								}
							}
						}
					}

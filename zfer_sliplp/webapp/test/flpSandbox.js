		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ERzfersliplp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ERzfersliplp-display": {
								"semanticObject": "ERzfersliplp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ER.zfersliplp",
									"url": sap.ui.require.toUrl("ER/zfersliplp")
								}
							}
						}
					}

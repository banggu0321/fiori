		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실적 차트 ",
									"targetURL": "#ERzferslipchart-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ERzferslipchart-display": {
								"semanticObject": "ERzferslipchart",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ER.zferslipchart",
									"url": sap.ui.require.toUrl("ER/zferslipchart")
								}
							}
						}
					}

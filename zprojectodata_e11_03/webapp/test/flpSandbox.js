		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zprojectdatae1103-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zprojectdatae1103-display": {
								"semanticObject": "zprojectdatae1103",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zprojectdatae1103",
									"url": sap.ui.require.toUrl("zprojectdatae1103")
								}
							}
						}
					}
